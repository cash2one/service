...
function updateinfo(){					
	...
	$(document).ready(function(){
		  ...
		  $("#btn_getcode").bind('click',function(){
			...
			dcount=1*120;
			$.ajax({
			  	url: '<?php echo U('userauth/smssend');?>',
		        type: "post",
				data:{
					'phone':u,
					},
